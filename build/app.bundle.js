...
function getPosts() {
  ...
  // since what we get is async, it return a promise
  // so how we deal a promise is with .then() and .catch() if there is any errors 
  .then(function (data) {
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return fetch(url, {
                  ...
                  // body: JSON.stringify(data)
                  // we get rid of the body because we're not sending data
                });
...
// We're still using Object Oriented Programming to create the UI Module
var UI = function () {
  function UI() {
  ...
  _createClass(UI, [{
    ...
    value: function fillForm(data) {
      ...
      var button = document.querySelector(".post-cancel");
    ...
    value: function changeFormState(type) {
      if (type === 'edit') {
        ...
        // Get span element to insert before
